...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillEnterForeground(application: UIApplication) {
        ...
        if (self.backgroundedDate != nil)
        {
            ...
            let sessionTimeout = defaults.doubleForKey(kSessionTimeString)
            ...
            {
                NSNotificationCenter.defaultCenter().postNotificationName(kNeedToTimeOutString, object: nil)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource(kSmack, withExtension: kExtension)!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent(kSqliteURL)
        ...
        do {
            ...
            dict[NSLocalizedDescriptionKey] = kFailedToInitSavedDataString
